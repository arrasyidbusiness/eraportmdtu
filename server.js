...
app.post('/api/create-transaction', async (req,res)=>{
  try{
    ...
    const { nama, wa, email, madrasah='', catatan='', paymentMode='all' } = req.body || {};
    ...
    // Mobile-first shortcut: QRIS/GoPay as primary payment path.
    // Midtrans Snap will only offer GoPay/QRIS for this transaction.
    if(String(paymentMode).toLowerCase() === 'qris'){
    ...
    saveOrder({
      ...
      grossAmount: PRICE,
      paymentMode: String(paymentMode).toLowerCase(),
      snapToken:d.token,
